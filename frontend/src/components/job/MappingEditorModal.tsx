...
export default function MappingEditorModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      />
      <div
        className="relative w-full max-w-5xl h-[80vh] bg-[#161b27] border border-[#30363d]
      ...
      >
        ...
        <div className="flex flex-1 min-h-0">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {sourceGroups.map((group) => (
                <div key={group.nodeId}>
                  {/* Node header */}
                  <div
                    className="px-3 py-2 bg-[#1c2333] border-b border-[#21262d]"
                  ...
                  {group.loading ? (
                    ...
                    <div className="px-3 py-2 text-xs text-[#484f58]">
                      컬럼 정보 없음
                    </div>
                  ) : (
                      ...
                      return (
                        ...
                        >
                          <span
                            ...
                            style={{
                              backgroundColor: mapped ? group.color : "#30363d",
                            }}
                          />
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-xs text-[#c9d1d9] truncate font-mono">
                                {col.columnName}
                              </span>
                            </div>
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            {/* Column Headers */}
            <div
              className="grid grid-cols-[28px_1fr_1fr_1fr_80px_32px] gap-0 border-b border-[#21262d]
        ...
        {showExprWarning && (
          <div
            className="flex items-start justify-between gap-3 px-5 py-3 border-t border-[#d29922]/40
            bg-[#2d2000] flex-shrink-0"
          >
        ...
        {/* Footer */}
        <div
          className="flex items-center justify-between px-5 py-3 border-t border-[#30363d] flex-shrink-0
          bg-[#0d1117]"
        >
          <p className="text-xs text-[#484f58]">
