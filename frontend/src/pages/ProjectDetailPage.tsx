  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <Input
        ...
        placeholder="e.g. Extract Sales Data"
        autoFocus
      />
      <Textarea
        label="Description"
...
export default function ProjectDetailPage() {
  ...
  useEffect(() => {
    if (!projectId) return;
    Promise.all([projectsApi.get(projectId), jobsApi.list(projectId)])
      .then(([p, j]) => {
        setProject(p);
        setJobs(projectId, j);
      })
  ...
  const handleSave = async (data: { name: string; description: string }) => {
    ...
    if (editing) {
      ...
      const created = await jobsApi.create(projectId, {
        ...data,
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <h1 className="text-xl font-bold text-[#232B37]">
              {project?.name}
            </h1>
            {project?.description && (
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3 min-w-0">
                    <div
                      className="w-8 h-8 rounded-lg bg-[#1c2333] border border-[#232B37]
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-medium text-[#232B37] group-hover:text-[#58a6ff] transition-colors">
                          {job.name}
                        </span>
                        <Badge
                          variant={
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <svg
                      className="w-4 h-4 text-[#484f58] group-hover:text-[#58a6ff] transition-colors"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
