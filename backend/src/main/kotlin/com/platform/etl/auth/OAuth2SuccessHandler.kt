...
class OAuth2SuccessHandler(
    ...
    override fun onAuthenticationSuccess(
        ...
        // 3. Refresh Token → HttpOnly + SameSite=Lax 쿠키 (헤더 직접 설정)
        val maxAge = (refreshDays * 24 * 60 * 60).toInt()
        response.addHeader("Set-Cookie",
            "etl_refresh=$rawRefreshToken; Path=/api/auth; HttpOnly; SameSite=Lax; Max-Age=$maxAge")
